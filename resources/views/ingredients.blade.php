...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addIngredients" data-whatever="@addIngredients">Thêm nguyên liệu</button>
        <!-- Add Ingredients -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Thêm nguyên liệu mới</h5>
                    ...
                    <form id="add_ingredients" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="ingredients" class="col-form-label">Tên nguyên liệu</label>
                                <input type="text" class="form-control" name="ingredients" id="ingredients" placeholder="Nhập tên nguyên liệu">
                            </div>
                            <div class="form-group">
        ...
        <div class="modal fade" id="EditIngredients" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabeledit" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form method="post" name="editingredients" class="editingredients" id="editingredients" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabeledit">Chỉnh sửa nguyên liệu</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <span id="emsg"></span>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="get_ingredients" class="col-form-label">Tên nguyên liệu</label>
                                <input type="text" class="form-control" id="get_ingredients" name="ingredients" placeholder="Nhập tên nguyên liệu">
                            </div>
                            <div class="form-group">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response == 1) {
                            swal({
                                    title: "Thành công!",
                                    text: "Trạng thái nguyên liệu đã được thay đổi",
                                    type: "success",
                                    showCancelButton: true,
                                    confirmButtonClass: "btn-danger",
...
function Delete(id) {
    swal({
            title: "Bạn chắc chứ?",
            text: "Bạn có muốn xóa nguyên liệu này ?",
            type: "warning",
            showCancelButton: true,
            confirmButtonClass: "btn-danger",
            confirmButtonText: "Có",
