                    ...
                    <div id="privacy-policy-three" class="privacy-policy">
                        <form method="post" name="about" id="about" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="about_content" class="col-form-label">Nội dung thông tin:</label>
                            ...
                            <div class="form-group">
                                <label for="mobile" class="col-form-label">Số điện thoại liên hệ:</label>
