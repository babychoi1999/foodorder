                        ...
                        <form action="{{ URL::to('admin/time/store') }}" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3" style="text-align: center;">
                                    <label><strong>Giờ mở cửa</strong></label>
                                </div>
                                <div class="form-group col-md-3" style="text-align: center;">
                                    <label><strong>Giờ đóng cửa</strong></label>
                                </div>
                                <div class="form-group col-md-3" style="text-align: center;">
                                    <label><strong>Cửa hàng đóng cửa cả ngày?</strong></label>
                                </div>
                            </div>
                            @foreach ($gettime as $time)
                            <div class="form-row">
                                @if ($time->day == "Monday")
                                <label class="col-sm-2 col-form-label">Thứ hai</label>
                                @endif
                                @if ($time->day == "Tuesday")
                                <label class="col-sm-2 col-form-label">Thứ ba</label>
                                @endif
                                @if ($time->day == "Wednesday")
                                <label class="col-sm-2 col-form-label">Thứ tư</label>
                                @endif
                                @if ($time->day == "Thursday")
                                <label class="col-sm-2 col-form-label">Thứ năm</label>
                                @endif
                                @if ($time->day == "Friday")
                                <label class="col-sm-2 col-form-label">Thứ sáu</label>
                                @endif
                                @if ($time->day == "Saturday")
                                <label class="col-sm-2 col-form-label">Thứ bảy</label>
                                @endif
                                @if ($time->day == "Sunday")
                                ...
                                <div class="form-group col-md-3">
                                    <select class="form-control" name="always_close[]" id="always_close{{$time->day}}">
                                        {{-- <option value="">Đóng cửa cả ngày</option>
                                        --}}
                                        <option value="1" @if ($time->always_close == '1') selected @endif>Có</option>
