...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addSlider" data-whatever="@addSlider">Thêm slide</button>
        <!-- Add Slider -->
                    ...
                    <form id="add_slider" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="title" class="col-form-label">Slide</label>
                                <input type="text" class="form-control" name="title" id="title" placeholder="Tiêu đề slide">
                            </div>
                            <div class="form-group">
        ...
        <div class="modal fade" id="EditSlider" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabeledit" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form method="post" name="editslider" class="editslider" id="editslider" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabeledit">Sửa slide</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <span id="emsg"></span>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="get_title" class="col-form-label">Tiêu đề slide</label>
                                <input type="text" class="form-control" id="get_title" name="title" placeholder="Tiêu đề">
                            </div>
                            <div class="form-group">
                                <label for="get_description" class="col-form-label">Mô tả</label>
                                <textarea name="description" id="get_description" class="form-control" rows="4" placeholder="mô tả"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="image" class="col-form-label">Hình ảnh</label>
                                <input type="file" class="form-control" name="image" id="image" accept="image/*">
