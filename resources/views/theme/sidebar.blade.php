        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="{{URL::to('/admin/slider')}}" aria-expanded="false">
                    <i class="fa fa-image"></i><span class="nav-text">Slides</span>
                </a>
            </li>
            <li>
                <a href="{{URL::to('/admin/category')}}" aria-expanded="false">
                    <i class="icon-menu menu-icon"></i><span class="nav-text">Loại sản phẩm</span>
                </a>
            </li>
            <li>
                <a href="{{URL::to('/admin/item')}}" aria-expanded="false">
                    <i class="fa fa-plus"></i><span class="nav-text">Sản phẩm</span>
                </a>
            </li>
            <li>
                <a href="{{URL::to('/admin/addons')}}" aria-expanded="false">
                    <i class="fa fa-plus"></i><span class="nav-text">Sản phẩm thêm</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{URL::to('/admin/pincode')}}" aria-expanded="false">
                    <i class="fa fa-map-pin" aria-hidden="true"></i><span class="nav-text">Mã vùng</span>
                </a>
            </li>
            <li>
                <a href="{{URL::to('/admin/promocode')}}" aria-expanded="false">
                    <i class="fa fa-tag"></i><span class="nav-text">Mã giảm giá</span>
                </a>
            </li>
            <li>
                <a href="{{URL::to('/admin/driver')}}" aria-expanded="false">
                    <i class="fa fa-car"></i><span class="nav-text">Tài xế</span>
                </a>
            </li>
            <li>
                <a href="{{URL::to('/admin/time')}}" aria-expanded="false">
                    <i class="fa fa-clock-o"></i><span class="nav-text">Giờ làm việc</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{URL::to('/admin/users')}}" aria-expanded="false">
                    <i class="fa fa-users"></i><span class="nav-text">Người dùng</span>
                </a>
            </li>
            <li>
                <a href="{{URL::to('/admin/reviews')}}" aria-expanded="false">
                    <i class="fa fa-star"></i><span class="nav-text">Đánh giá</span>
                </a>
            </li>
            <li>
                <a href="{{URL::to('/admin/report')}}" aria-expanded="false">
                    <i class="fa fa-bar-chart"></i><span class="nav-text">Báo cáo</span>
                </a>
            </li>
            <li>
            ...
            <li style="display: none;">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{URL::to('/admin/privacypolicy')}}">Chính sách riêng tư</a></li>
                    <li><a href="{{URL::to('/admin/termscondition')}}">Điều khoản & Dịch vụ</a></li>
                    <li><a href="{{URL::to('/admin/settings')}}">Thông tin và cài đặt</a></li>
                </ul>
            </li>
        </ul>
    </div>
