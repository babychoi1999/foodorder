...
<body>
    ...
    ********************-->
    <div id="main-wrapper">
                ...
                <div class="row my-2">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="post" id="change_password_form">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <input type="password" placeholder="Nhập mật khẩu cũ" class="form-control" name="oldpassword" id="oldpassword">
                                                </div>
                                                <label>Mật khẩu mới: </label>
                                                <div class="form-group">
                                                    <input type="password" placeholder="Nhập mật khẩu mới" class="form-control" name="newpassword" id="newpassword">
                                                </div>
                            ...
                            <!-- Modal Settings-->
                            <div class="modal fade text-left" id="Selltings" tabindex="-1" role="dialog" aria-labelledby="RditProduct" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <label class="modal-title text-text-bold-600" id="RditProduct">Cài đặt</label>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        ...
                                        <form method="post" id="settings">
                                                        ...
                                                        <div class="col-sm-3 col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                <a href="#" class="badge badge-primary px-2" onclick="getLocation()">
                                                                    Nhập để lấy vị trí hiện tại của bạn
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" placeholder="Giá trị đơn hàng tối thiểu" value="{{{Auth::user()->min_order_amount}}}" class="form-control" name="min_order_amount" id="min_order_amount">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3 col-md-4">
                                                            <div class="form-group">
                                                                <label>Giá trị đơn hàng tối đa: </label>
                                                                <input type="text" placeholder="Giá trị đơn hàng tối đa" value="{{{Auth::user()->max_order_amount}}}" class="form-control" name="max_order_amount" id="max_order_amount">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            @if (env('Environment') == 'sendbox')
                                            <div class="modal-footer">
                                                <input type="reset" class="btn btn-outline-secondary btn-lg" data-dismiss="modal" value="Đóng">
                                                <input type="button" class="btn btn-outline-primary btn-lg" onclick="myFunction()" value="Cập nhật">
                                            </div>
                                            @else
                                            <div class="modal-footer">
                                                <input type="reset" class="btn btn-outline-secondary btn-lg" data-dismiss="modal" value="Đóng">
                                                <input type="button" class="btn btn-outline-primary btn-lg" onclick="settings()" value="Cập nhật">
                                            </div>
                                            @endif
                                        </form>
                                    </div>
        ...
        <div class="modal fade text-left" id="iconModal" tabindex="-1" role="dialog" aria-labelledby="RditProduct" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <label class="modal-title text-text-bold-600" id="RditProduct">
                            <h3><i class="fa fa-bell" aria-hidden="true"></i> Be aware !!!</h3>
                        </label>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    ...
                    <div class="modal-body">
                        ...
                        <hr>
                        <h5><i class="fa fa-envelope" aria-hidden="true"></i> Contact at : <a href="javascript:void(0)">babychoi1999@gmail.com</a></h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Bản quyền &copy; Thiết kế & Phát triển bởi <a href="https://www.facebook.com/ngoctuan99yaly" target="_blank">Trần Ngọc Tuân</a> 04/2021</p>
            </div>
        </div>
        <!--**********************************
            Footer end
