        ...
        <div id="sync1" class="owl-carousel owl-theme">
            ...
            <div class="item">
                <div class="tab-pane">
                    ...
                    <a href="{{URL::to('product/')}}" class="btn">Xem thêm</a>
                </div>
            </div>
            <?php $i++; ?>
            @endforeach
...
<section class="feature-sec">
    <h2 class="sec-head">Sản phẩm nổi bật</h2>
    <div class="container">
        <div class="feature-carousel owl-carousel owl-theme">
            @foreach ($getfeaturedItem as $ft)
            <div class="item">
                <div class="feature-box" style="height: 250px;">
                    <a href="{{URL::to('product-details/'.$ft->id)}}">
                        <img src='{{$ft["itemimage"]->image }}' alt="">
                    </a>
                    <div class="feature-contant">
                    </div>
                </div>
...
<section class="review-sec">
    <div class="container">
        <h2 class="sec-head">Nhận xét của khách hàng</h2>
...
<section class="contact-from">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h2 class="sec-head">Liên hệ với chúng tôi</h2>
                @if($getabout->mobile != "")
            ...
            <div class="col-lg-6">
                <form class="contact-form" id="contactform" method="post">
                    ...
                    <textarea name="message" placeholder="Lời nhắn*" id="message" required=""></textarea>
                    <button type="button" name="submit" class="btn" onclick="contact()">Gửi</button>
                </form>
            </div>
        </div>
    </div>
