                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item {{ request()->is('product') ? 'active' : '' }}">
                            <a class="nav-link" href="{{URL::to('/product')}}">Sản phẩm</a>
                        </li>
                        @if (Session::get('id'))
                        <li class="nav-item {{ request()->is('orders') ? 'active' : '' }}">
                            <a class="nav-link" href="{{URL::to('/orders')}}">Đơn hàng của tôi</a>
                        </li>
                        <li class="nav-item {{ request()->is('favorite') ? 'active' : '' }}">
                            <a class="nav-link" href="{{URL::to('/favorite')}}">Yêu thích</a>
                        </li>
                        <li class="nav-item {{ request()->is('wallet') ? 'active' : '' }}">
                            <a class="nav-link" href="{{URL::to('/wallet')}}">Ví của tôi</a>
                        </li>
                        ...
                        @else
                        <li class="nav-item">
                            <a class="nav-link btn sign-btn" href="{{URL::to('/signin')}}">Đăng nhập</a>
                        </li>
                        @endif
                    </ul>
                </div>
